...
#autre
    path(
        "parameters/typepaiements/list/",
        view=views.TypePaiementListView.as_view(),
        name="typepaiement-list",
    ),
    path(
        "parameters/typepaiements/create/",
        view=views.TypePaiementCreateView.as_view(),
        name="typepaiement-create",
    ),
    path(
        "parameters/typepaiements/<slug:slug>/detail/",
        view=views.TypePaiementDetailView.as_view(),
        name="typepaiement-detail",
    ),
    path(
        "parameters/typepaiements/<slug:slug>/update/",
        view=views.TypePaiementUpdateView.as_view(),
        name="typepaiement-update",
    ),
    path(
        "parameters/typepaiements/<slug:slug>/delete/",
        view=views.TypePaiementDeleteView.as_view(),
        name="typepaiement-delete",
    ),
]

...
env = environ.Env()
environ.Env.read_env(env_file=str(BASE_DIR / "educ_finance" / ".env.local"))
...
ROOT_URLCONF = "educ_finance.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [
            BASE_DIR / "educ_finance/templates",
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "educ_finance.context_processors.get_icons_size",
            ],
        },
    },
]

# WSGI_APPLICATION = "educ_finance.wsgi.application"
